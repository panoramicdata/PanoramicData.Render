...
- [x] 7.4.6 — Integrate column layout with floating objects: wrapping within a column
- [x] 7.4.7 — Unit tests: verify column flow and break positions
...
- [x] 7.7.3 — Handle leader characters: dot leader, hyphen leader, underscore leader, heavy leader
- [x] 7.7.4 — Handle right-aligned tab in headers/footers (common pattern for page numbers)
- [x] 7.7.5 — Unit tests: verify each tab stop type and leader style

### 7.8 RTL & BiDi Text

- [x] 7.8.1 — Detect RTL paragraphs (`w:bidi`) and RTL runs (`w:rtl`)
...
- [x] 7.8.6 — Unit tests: verify RTL text layout, mixed BiDi paragraphs, and RTL table layout
