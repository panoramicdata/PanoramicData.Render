...
- [ ] 6.3.1 — Implement WOFF2 conversion: convert `.ttf`/`.otf` font data to WOFF2 format
- [ ] 6.3.2 — Embed fonts as Base64 WOFF2 in `<style>` → `@font-face` blocks within the SVG
- [ ] 6.3.3 — Only embed fonts actually used on each page (not all document fonts)
