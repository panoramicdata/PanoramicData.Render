...
- [x] 5.3.2 — **Tight wrapping:** Text flows around the image's wrap polygon (`wp:wrapTight` → `wp:wrapPolygon`)
...
- [x] 5.3.7 — Unit tests: verify text wrapping produces correct line widths and positions
